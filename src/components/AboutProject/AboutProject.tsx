    ...
    <section className="about-project">
      ...
      <div className="about-project__scales">
        <div className="about-project__scale about-project__scale_backend">
          <p className="about-project__duration about-project__duration_backend">
            1 неделя
          </p>
          <p className="about-project__stage about-project__stage_backend">
            back-end
          </p>
        </div>
        <div className="about-project__scale about-project__scale_frontend">
          <p className="about-project__duration about-project__duration_frontend">
            4 недели
          </p>
          <p className="about-project__stage about-project__stage_frontend">
            front-end
          </p>
        </div>
      </div>
