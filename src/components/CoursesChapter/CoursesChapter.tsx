...
const CoursesChapter = ({chapter, courseСhapters, setCoursesСhapter} : {chapter: any, courseСhapters: any, setCoursesСhapter: (value: any) => void;}) => {
    ...
    const handleDeleteGroup = () => {
        const newCourseChapters = courseСhapters.filter((item: any) => item.key !== chapter.key);
